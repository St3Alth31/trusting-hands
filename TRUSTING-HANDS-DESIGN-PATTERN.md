cat > /mnt/user-data/outputs/TRUSTING-HANDS-DESIGN-PATTERN.md << 'ENDOFFILE'
...
**Pattern:** Warm human service editorial — community trust, institutional credibility.

**Feeling:** Welcoming, dependable, professional without being cold. Forest green anchors the brand with depth and growth. Golden yellow signals warmth and care. White space and clean typography keep the site from feeling cluttered or transactional.

**Why these choices exist:**  
Trusting Hands serves two audiences who need opposite reassurances. A household employer needs to feel the agency is warm, careful, and protective of their home. An institutional client (a hospital, a hotel) needs to feel the agency is professional, organised, and reliable at scale. The deep forest green from the logo — the color of growth, trust, and nature — bridges both audiences. The golden yellow (the house outline in the logo) keeps it from feeling corporate. Together they signal: serious but human.

The logo itself encodes the brand promise — two cupped hands holding a green heart inside a golden house. That symbolism (care, home, trust) must be felt throughout the site, not just displayed in the header.

If an edit would look at home on a generic staffing agency site (blue corporate banners, grey sans-serif grids, stock photos of suited HR professionals), it is the wrong direction. This brand is warmer and more personal than that.
...
| 6 | `components/audiences-section.tsx` | `#clients` | Light — households left, institutions right |
...
- Two-column split on desktop, `border-r border-[--border]` divider.
- Left (Households): eyebrow "For Your Home", H3 "Trusted Help at Home", body copy, list of worker types (House Helpers, Cooks, Cleaners, Nannies, Care Support) as hairline-separated rows.
- Right (Institutions): eyebrow "For Your Business", H3 "Reliable Staff for Any Setting", body copy, list of venue types as hairline-separated rows.
- Each column ends with a WhatsApp underline CTA.
...
- [ ] Audiences section: two-column split with `border-r` hairline divider on desktop
...
- [ ] All contact actions resolve via `lib/contact.ts`
- [ ] Phone numbers confirmed with client before go-live
- [ ] Motion: `700ms` scroll reveals, `300ms` hovers, no bounce
- [ ] `prefers-reduced-motion` respected
- [ ] Mobile: `px-6`, stacked grids, working hamburger
- [ ] No stock photos of corporate HR professionals or posed office handshakes
